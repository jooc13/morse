...
{{- printf "postgresql://user:password@localhost:5432/morse" (include "morse.postgresql.username" .) .Values.postgresql.auth.password (include "morse.postgresql.host" .) (include "morse.postgresql.port" . | int) (include "morse.postgresql.database" .) }}
{{- end }}